...
Some puzzles
can be phrased conveniently as a search in the space of all logical possibilities (see [a_04a.prolog](a_04a.prolog))
and thus would be a perfect fit for Prolog. On the other hand, there are problems that boil down to emulating a Turing
machine (see [a_02b.prolog](a_02b.prolog)), which can be a bit frustrating to do in Prolog. The hope is that AoC problems
